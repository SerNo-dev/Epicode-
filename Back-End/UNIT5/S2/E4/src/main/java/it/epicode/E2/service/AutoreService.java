...
public class AutoreService {
    ...
    public String saveAutore(AutoreDto autoreDto) {
       AutoreBlog autoreBlog = new AutoreBlog();
        ...
        sendMail(autoreBlog.getEmail(), autoreBlog.getNome());
    ...
    private void sendMail(String email,String nome) {
        SimpleMailMessage message = new SimpleMailMessage();
        message.setTo(email);
        message.setSubject("Registrazione Servizio rest");
        message.setText("Registrazione al servizio rest avvenuta con successo Benvenuto/a " + nome);
