...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (typeof starWarsCharacters[i].name === 'string') {
...
let crewMass = 0;
let tot = 0
while (tot < starWarsCharacters.length) {
  crewMass += starWarsCharacters[tot].mass;
  tot++
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "n/a") {
    ...
    console.log('il restante ha già un genere stabilito')
  }
...
console.log('Il nome è ' + starWarsCharacters[casuale].name  + ' il peso è ' + starWarsCharacters[casuale].mass + ' l\'altezza è ' + starWarsCharacters[casuale].height );
